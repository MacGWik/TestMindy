...
<body>
    ...
    <div style="margin-top:6%;" class="center-block">
        ...
        <form action="dropdown_answer.php" method="POST">
            <div class="dropdown">
            <label>Select the Category: </label><br/>
            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
            <span id="selected">Chose option</span><span class="caret"></span></button>
            <ul class="dropdown-menu" >
                <li><a href="#" name="dropdown">Introvert vs Extrovert</a></li>
                <li><a href="#" name="dropdown">Sensing vs Intuiting</a></li>
                <li><a href="#" name="dropdown">Thinking vs Feeling</a></li>
                <li><a href="#" name="dropdown">Judging vs Perceiving</a></li>
            </ul>
            </div>
